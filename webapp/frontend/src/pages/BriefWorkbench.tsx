...
import type { ChecklistItem } from '../components/SelfCheck'
...
export default function BriefWorkbench() {
  ...
  return (
    <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 24px', width: '100%' }}>
      {/* Header */}
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 flex flex-col space-y-4" style={{ minWidth: 0 }}>
          ...
          {activePhase === 1 && (
            <>
              ...
              {briefContent && (
                <div className="flex flex-col flex-1 overflow-y-auto" style={{ minHeight: '500px' }}>
                  {/* Phase 1 sub-tabs */}
                  ...
                  <div className="flex-1 flex flex-col bg-canvas border-x border-b border-hairline rounded-b-sm overflow-hidden">
                    {phase1Tab === 'edit' && (
                      <textarea
                        ref={textareaRef}
                        className="w-full p-6 font-mono text-sm resize-none bg-surface-soft text-ink placeholder:text-muted outline-none border-0 focus:outline-none"
                    ...
                    {phase1Tab === 'preview' && (
                      <div className="p-6 overflow-y-auto" style={{ minHeight: '500px', flex: 1 }}>
                        {briefContent ? (
        ...
        {/* Right sidebar: sticky 固定，内容独立滚动 */}
        <div className="w-80 flex flex-col flex-shrink-0" style={{ position: 'sticky', top: '96px', height: 'calc(100vh - 116px)' }}>
          ...
          {/* Self-Check */}
          <SelfCheck items={CHECKLIST} content={briefContent} />

          {/* Version history */}
          <VersionHistory entries={versionHistory} />
          </div>
        </div>
      </div>
    </div>
